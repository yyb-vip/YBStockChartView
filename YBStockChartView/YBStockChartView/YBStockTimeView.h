...
@class YBStockTimeView;
@protocol YBStockTimeViewDelegate <NSObject>
...
@interface YBStockTimeView : UIView

@property (nonatomic, assign) id<YBStockTimeViewDelegate>delegate;

/** 数据源 **/
@property (nonatomic, strong) NSMutableArray <YBStockTimeModel *> *dataArray;
